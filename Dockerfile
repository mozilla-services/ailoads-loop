...
RUN \
    apt-get update; \
    apt-get install -y python3-pip python3-venv python3-virtualenv git build-essential make; \
	...
	apt-get remove -y -qq git build-essential make python3-pip python3-venv python3-virtualenv libssl-dev libffi-dev; \
